...
#define YT_MIN_X 73.33
#define YT_MAX_X 135.05
#define YT_MIN_Y 3.51
#define YT_MAX_Y 53.33
...
#define DFE_Server_URL2 @"http://ytbus.jiaodong.cn:4990"
...
// 数据库下载地址:ytbus.jiaodong.cn:4998/SynBusSoftWebservice/DownloadServlet?method=downloadDb

#define Default_Realtime_Port @"4990"
#define GetBusLineStatus_SOAP_URL @"http://ytbus.jiaodong.cn:%@/BusPosition.asmx"
#define GetBusLineStatus_SOAP_MSG @"<?xml version=\"1.0\" encoding=\"utf-8\"?>"                                            @"<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"                                                                       @"  <soap:Body>"                                                                                                                    @"      <GetBusLineStatusEx xmlns=\"http://www.dongfang-china.com/\">"                                                                    @"          <stationID>%@</stationID>"                                                                                                  @"          <lineID>%@</lineID>"                                                                                                                @"          <lineStatus>%@</lineStatus>"                                                                                                        @"          <userRole>0</userRole>"                                                                                       @"          <attach>%d</attach>"                                                                                                        @"      </GetBusLineStatusEx>"                                                                                                                @"  </soap:Body>"                                                                                                                       @"</soap:Envelope>"
#define GetBusLineStatus_SOAP_MSG_Encrypt @"<?xml version=\"1.0\" encoding=\"utf-8\"?>"                                            @"<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"                                                                       @"  <soap:Body>"                                                                                                                    @"      <GetBusLineStatusEncry xmlns=\"http://www.dongfang-china.com/\">"                                                                    @"          <stationID>%@</stationID>"                                                                                                  @"          <lineID>%@</lineID>"                                                                                                                @"          <lineStatus>%@</lineStatus>"                                                                                                        @"          <userRole>0</userRole>"                                                                                       @"          <attach>%d</attach>"                                                                                                        @"          <strSession>%@</strSession>"                                                                                 @"          <strFlag>%@</strFlag>"                                                                                      @"          <strIMEI>%@</strIMEI>"                                                                                    @"      </GetBusLineStatusEncry>"                                                                                                                @"  </soap:Body>"                                                                                                                       @"</soap:Envelope>"

#define GetDbVersion_SOAP_URL @"http://ytbus.jiaodong.cn:4998/SynBusSoftWebservice/services/SynBusSoft"
#define GetDbVersion_SOAP_MSG @"<?xml version=\"1.0\" encoding=\"utf-8\"?>"                                                                                                             @"<soap:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\">"                                                                                                                          @"  <soap:Body>"                                                                                                                                                    @"      <getNewDbVersion>"                                                                                                                                               @"      </getNewDbVersion>"                                                                                                                                    @"  </soap:Body>"                                                                                                                                                           @"</soap:Envelope>"
